...
class MoveItDemo:
    def __init__(self):
        ...
        # Start the arm target in "up" pose stored in the SRDF file
        ...
        # the kinematic tree.
        joint_positions = [0.0302989639844, 0.838363731146, 0.470812944197, 0.028010712106, 0, 0]
        ...
        # Control the orientation of the gripper
        target_pose = Pose()

        target_pose.position.x = 0.562843399331
        target_pose.position.y = -0.481554348516 
        target_pose.position.z = 0.593540464219
