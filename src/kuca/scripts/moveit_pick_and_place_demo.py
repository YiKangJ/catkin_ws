...
GRIPPER_JOINT_NAMES = ['gripper_active_finger_joint']
...
class MoveItDemo:
    def __init__(self):
        ...
        box1_pose.pose.position.x = 0.36
        ...
        box2_pose.pose.position.x = 0.34
        ...
        target_pose.pose.position.x = 0.37
        ...
        place_pose.pose.position.x = 0.33
