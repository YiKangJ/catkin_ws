...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'tensorflow_mnist' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/jyk/catkin_ws/src/ros_exploring/robot_learning/tensorflow_mnist/${idir}'.  ${_report}")
    endif()
